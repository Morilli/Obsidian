...
namespace Obsidian.Utils
{
    public static class WADHashGenerator
    {
        ...
        private static IEnumerable<string> ProcessBINValue(BINValue value)
        {
            ...
            {
                strings.AddRange(ProcessBINOptionalData(value.Value as BINOptional));
            }
        ...
        private static IEnumerable<string> ProcessBINOptionalData(BINOptional optionalData)
        {
            return (optionalData.Value == null) ? new List<string>() : ProcessBINValue(optionalData.Value);
        }
